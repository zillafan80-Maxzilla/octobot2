...
if check_tentacle_version('1.2.0', 'hyperliquid_websocket_feed', 'OctoBot-Default-Tentacles'):
    try:
        from .hyperliquid_websocket_feed import *
    except Exception as e:
        get_logger('TentacleLoader').error(f'Error when loading hyperliquid_websocket_feed: '
                                           f'{e.__class__.__name__}{f" ({e})" if f"{e}" else ""}. If this '
                                           f'error persists, try reinstalling your tentacles via '
                                           f'"python start.py tentacles --install --all".')

if check_tentacle_version('1.2.0', 'okxus_websocket_feed', 'OctoBot-Default-Tentacles'):
    try:
        from .okxus_websocket_feed import *
    except Exception as e:
        get_logger('TentacleLoader').error(f'Error when loading okxus_websocket_feed: '
                                           f'{e.__class__.__name__}{f" ({e})" if f"{e}" else ""}. If this '
                                           f'error persists, try reinstalling your tentacles via '
                                           f'"python start.py tentacles --install --all".')
...
if check_tentacle_version('1.2.0', 'hyperliquid', 'OctoBot-Default-Tentacles'):
    try:
        from .hyperliquid import *
    except Exception as e:
        get_logger('TentacleLoader').error(f'Error when loading hyperliquid: '
                                           f'{e.__class__.__name__}{f" ({e})" if f"{e}" else ""}. If this '
                                           f'error persists, try reinstalling your tentacles via '
                                           f'"python start.py tentacles --install --all".')
...
if check_tentacle_version('1.2.0', 'okxus', 'OctoBot-Default-Tentacles'):
    try:
        from .okxus import *
    except Exception as e:
        get_logger('TentacleLoader').error(f'Error when loading okxus: '
                                           f'{e.__class__.__name__}{f" ({e})" if f"{e}" else ""}. If this '
                                           f'error persists, try reinstalling your tentacles via '
                                           f'"python start.py tentacles --install --all".')
...
if check_tentacle_version('1.2.0', 'polymarket', 'OctoBot-Default-Tentacles'):
    try:
        from .polymarket import *
    except Exception as e:
        get_logger('TentacleLoader').error(f'Error when loading polymarket: '
                                           f'{e.__class__.__name__}{f" ({e})" if f"{e}" else ""}. If this '
                                           f'error persists, try reinstalling your tentacles via '
                                           f'"python start.py tentacles --install --all".')

if check_tentacle_version('1.2.0', 'polymarket_websocket_feed', 'OctoBot-Default-Tentacles'):
    try:
        from .polymarket_websocket_feed import *
    except Exception as e:
        get_logger('TentacleLoader').error(f'Error when loading polymarket_websocket_feed: '
                                           f'{e.__class__.__name__}{f" ({e})" if f"{e}" else ""}. If this '
                                           f'error persists, try reinstalling your tentacles via '
                                           f'"python start.py tentacles --install --all".')
...
if check_tentacle_version('1.2.0', 'hollaex_websocket_feed', 'OctoBot-Default-Tentacles'):
    try:
...
if check_tentacle_version('1.2.0', 'coinbase_websocket_feed', 'OctoBot-Default-Tentacles'):
    try:
        from .coinbase_websocket_feed import *
    except Exception as e:
        get_logger('TentacleLoader').error(f'Error when loading coinbase_websocket_feed: '
                                           f'{e.__class__.__name__}{f" ({e})" if f"{e}" else ""}. If this '
                                           f'error persists, try reinstalling your tentacles via '
                                           f'"python start.py tentacles --install --all".')
...
if check_tentacle_version('1.2.0', 'myokx', 'OctoBot-Default-Tentacles'):
    try:
        from .myokx import *
    except Exception as e:
        get_logger('TentacleLoader').error(f'Error when loading myokx: '
                                           f'{e.__class__.__name__}{f" ({e})" if f"{e}" else ""}. If this '
                                           f'error persists, try reinstalling your tentacles via '
                                           f'"python start.py tentacles --install --all".')
...
if check_tentacle_version('1.2.0', 'myokx_websocket_feed', 'OctoBot-Default-Tentacles'):
    try:
        from .myokx_websocket_feed import *
    except Exception as e:
        get_logger('TentacleLoader').error(f'Error when loading myokx_websocket_feed: '
                                           f'{e.__class__.__name__}{f" ({e})" if f"{e}" else ""}. If this '
                                           f'error persists, try reinstalling your tentacles via '
                                           f'"python start.py tentacles --install --all".')
